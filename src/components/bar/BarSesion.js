...
import logo from './../../assets/LOGOS_RGB-03.png'
import logoOspedyc from '../../assets/LOGOS_RGB-04.png'
    ...
    <React.Fragment>
      ...
      >
        <div className={classes.list} onKeyDown={cerrarMenuIzquierda}>
          {
            sessionStorage.getItem("es_afiliado") &&
            <img src={logo} style={{ objectFit: "contain", width: "100%", height: 175, display: "block" }} alt="Logo Afiliado" />
          }
      ...
      <Toolbar>
        {
          !sessionStorage.getItem("es_afiliado") &&
          <IconButton color="inherit" onClick={volverAlPortal}>
        ...
        <Avatar src={logoOspedyc} className={classes.white}></Avatar> <Typography variant="h6">OSPEDYC</Typography>
